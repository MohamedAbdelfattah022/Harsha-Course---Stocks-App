...
// 					{ StockSymbol = "MSFT", StockName = "Microsoft", Price = 1, Quantity = buyOrderQuantity };
//
// 			//Act
...
// 			//Arrange
// 			BuyOrderRequest? buyOrderRequest = new BuyOrderRequest()
// 					{ StockSymbol = "MSFT", StockName = "Microsoft", Price = buyOrderPrice, Quantity = 1 };
//
// 			//Act
// 			Assert.Throws<ArgumentException>(() => { _stocksService.CreateBuyOrder(buyOrderRequest); });
// 		}
...
// 			//Arrange
// 			BuyOrderRequest? buyOrderRequest = new BuyOrderRequest()
// 					{ StockSymbol = "MSFT", StockName = "Microsoft", DateAndTimeOfOrder = Convert.ToDateTime("1999-12-31"), Price = 1, Quantity = 1 };
//
// 			//Act
// 			Assert.Throws<ArgumentException>(() => { _stocksService.CreateBuyOrder(buyOrderRequest); });
// 		}
...
// 			//Arrange
// 			BuyOrderRequest? buyOrderRequest = new BuyOrderRequest()
// 					{ StockSymbol = "MSFT", StockName = "Microsoft", DateAndTimeOfOrder = Convert.ToDateTime("2024-12-31"), Price = 1, Quantity = 1 };
//
// 			//Act
...
// 					{ StockSymbol = "MSFT", StockName = "Microsoft", Price = 1, Quantity = sellOrderQuantity };
//
// 			//Act
...
// 			//Arrange
// 			SellOrderRequest? sellOrderRequest = new SellOrderRequest()
// 					{ StockSymbol = "MSFT", StockName = "Microsoft", Price = sellOrderPrice, Quantity = 1 };
//
// 			//Act
// 			Assert.Throws<ArgumentException>(() => { _stocksService.CreateSellOrder(sellOrderRequest); });
// 		}
...
// 			BuyOrderRequest buyOrder_request_1 = new BuyOrderRequest()
// 				{
// 					StockSymbol = "MSFT", StockName = "Microsoft", Price = 1, Quantity = 1, DateAndTimeOfOrder = DateTime.Parse("2023-01-01 9:00")
// 				};
//
// 			BuyOrderRequest buyOrder_request_2 = new BuyOrderRequest()
// 				{
// 					StockSymbol = "MSFT", StockName = "Microsoft", Price = 1, Quantity = 1, DateAndTimeOfOrder = DateTime.Parse("2023-01-01 9:00")
// 				};
//
...
// 			SellOrderRequest sellOrder_request_1 = new SellOrderRequest()
// 				{
// 					StockSymbol = "MSFT", StockName = "Microsoft", Price = 1, Quantity = 1, DateAndTimeOfOrder = DateTime.Parse("2023-01-01 9:00")
// 				};
//
// 			SellOrderRequest sellOrder_request_2 = new SellOrderRequest()
// 				{
// 					StockSymbol = "MSFT", StockName = "Microsoft", Price = 1, Quantity = 1, DateAndTimeOfOrder = DateTime.Parse("2023-01-01 9:00")
// 				};
//
